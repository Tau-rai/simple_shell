...
void print_error(char *name, int *num_cmd, char *command, char *message);
...
void shell_fork(char **args, char **env, char *nme, char *pth, int *n, int *e);
int check_cmd(char *cmd, char **envp, char *name, int *num_cmd, int *e);
